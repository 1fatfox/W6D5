...
function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      ...
      var betterMinutes = checkTime(minutes);
      var betterSeconds = checkTime(seconds);
      var fullTime = hours + ':' + betterMinutes + ':' + betterSeconds;
      ...
      }, fullTime), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
        className: "date"
      }, fullDate));
    }
  }, {
...
function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var sel = this.props.selectedTabs;
      var head = this.props.docs.map(function (doc, idx) {
        var title = doc.title;
        var show = idx === sel ? 'active' : '';
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          key: idx,
          className: show,
          onClick: function onClick() {
            return _this.props.chosenTab(idx);
          }
        }, title);
      });
...
function (_React$Component2) {
  ...
  _createClass(Tabs, [{
    key: "render",
    value: function render() {
      var doc = this.props.docs[this.state.selectedTabs];
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "tabbed"
        ...
        className: "tab-stuff"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("article", null, doc.content))));
    }
  }, {
    key: "selectTab",
